...
void chamber_fill() {
    ...
    digitalWrite(AIR_VALVE, LOW); // Air valve closed
    digitalWrite(AERATION_PUMP, LOW); // Aeration pump turned off
    digitalWrite(WATER_PUMP, HIGH); // Water pump on
    // digitalWrite(FILL_VALVE, HIGH); // Water valve open
    digitalWrite(WATER_VALVE, LOW); // Water valve closed
    // digitalWrite(DRAIN_PUMP, LOW); // Water drain pump off
}
...
void chamber_aeration() {
    ...
    // digitalWrite(FILL_VALVE, LOW); // Water valve closed
    digitalWrite(WATER_VALVE, LOW); // Water valve closed
    // digitalWrite(DRAIN_PUMP, LOW); // Water drain pump off
}
...
void chamber_drain() {
    ...
    digitalWrite(AIR_VALVE, HIGH); // Air valve open, release chamber air
    digitalWrite(AERATION_PUMP, LOW); // Aeration pump turned off
    digitalWrite(WATER_PUMP, LOW); // Water pump off
    // digitalWrite(FILL_VALVE, LOW); // Water valve closed
    digitalWrite(WATER_VALVE, HIGH); // Water valve open, draining
    // digitalWrite(DRAIN_PUMP, HIGH); // Water drain pump on
}
